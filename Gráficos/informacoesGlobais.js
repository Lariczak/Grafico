...
async function visualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML = `Você sabia que o mundo tem <span>${pessoasMundo} bilhões</span> de pessoas e que aproximadamente <span>${pessoasConectadas} milhões</span> são de alguma comunidade vegana e estão em cerca de <span>${municipios}</span> mil no Brasil?<br>`;
